...
const { setFifteenMinFees , setThirtyMinutes ,getPlanAmount ,setBaseAmount ,getBaseAmount ,addTutorDetails ,getAllTutors ,loginTutor ,getAllTutorBooking} = require('../controllers/tutorController')
